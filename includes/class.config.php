<?PHP
    ...
    class Config
    {
        ...
        private $productionServers = array('/^bookoftheweek\.org\.ua$/');
        private $stagingServers    = array('/^bibliorodzynki365\.com\.ua$/');
        ...
        private function everywhere()
        {
            ...
            $this->authSalt   = 'indf78o89&^T&gbuycs75^vcs9';
        }
        ...
        private function production()
        {
            ...
            $this->dbReadHost      = 'lodb.mysql.ukraine.com.ua';
            $this->dbWriteHost     = 'lodb.mysql.ukraine.com.ua';
            $this->dbName          = 'lodb_botw';
            $this->dbReadUsername  = 'lodb_botw';
            $this->dbWriteUsername = 'lodb_botw';
            $this->dbReadPassword  = 'xagqge7w';
            $this->dbWritePassword = 'xagqge7w';
            $this->dbOnError       = 'die';
        ...
        private function staging()
        {
            ...
            $this->dbReadHost      = 'lodb.mysql.ukraine.com.ua';
            $this->dbWriteHost     = 'lodb.mysql.ukraine.com.ua';
            $this->dbName          = 'lodb_biblio';
            $this->dbReadUsername  = 'lodb_biblio';
            $this->dbWriteUsername = 'lodb_biblio';
            $this->dbReadPassword  = '7hhtzlc2';
            $this->dbWritePassword = '7hhtzlc2';
            $this->dbOnError       = 'die';
            $this->dbEmailOnError  = false;
        }
